  ...
  \begin{columns}[c]
    \begin{column}{0.52\textwidth}
      \begin{itemize}
        ...
        \item Flattened end-to-end $\rightarrow$ \hl{monotask} baseline --- one prompt, \hl{same data}
        \item \hl{$+414$ Auto} --- self-generated, successes only $\rightarrow$ \hl{Teleop+Auto}
        \item Also: \hl{60 public} end-to-end demos (LightwheelAI)
      \end{itemize}
    \end{column}
