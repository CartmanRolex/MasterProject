...
- **Keep the .md current.** Whenever you add, remove, rename, or significantly change a file or feature, update the AGENTS.md (and its CLAUDE.md mirror) in the same directory **in the same commit**. The `.md` and the code must always agree.
...
- **New directory or structural change?** Update the root AGENTS.md and root CLAUDE.md as well.
