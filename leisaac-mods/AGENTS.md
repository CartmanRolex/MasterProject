...
line also negates the world-Y (left/right) component (the left/right wrist roll
was inverted on this headset) — flip that sign if a rotation axis runs the wrong
way. Translation is **wrist-orientation-aware**: `get_device_state` passes
