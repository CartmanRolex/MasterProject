...
Rotation aid: the keyboard **L** key toggles a **forward-rotation (roll) lock** that
holds the gripper's roll about its own forward axis (the hand's roll is ignored) so
the wrist can drive pitch + translation without the roll drifting.
