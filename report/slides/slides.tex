  ...
  \begin{columns}[c]
    \begin{column}{0.40\textwidth}
      \begin{itemize}
        ...
        \item \hl{Subtasking effect} --- rarely empty-handed: \gn{$\geq$1 orange 97\%} vs.\ 56\%; completions $\pm$ a few pts
...
\begin{frame}{Grasp acquisition is the bottleneck}
  ...
  \vfill
  \centering
  \includegraphics[width=0.78\textwidth,height=0.355\textheight,keepaspectratio]{failure_modes_variants_subtask.pdf}\\[0.1em]
  \includegraphics[width=0.78\textwidth,height=0.275\textheight,keepaspectratio]{failure_modes_variants_monotask.pdf}
\end{frame}
